...
def test_TimerActiveCheck(hass):
    ...
    for t in timerActiveCheckTests:
        ...
        if out != expect:
            print(f"trigger.TimerActiveCheck({spec}, {now}) -> {out} vs expect {expect}")
        assert out == expect
...
timerTriggerNextTests = [
    ...
    [["period(2019/9/1 13:00, 120s)"], [dt(2019, 9, 1, 13, 2, 0, 0),
                                        dt(2019, 9, 1, 13, 4, 0, 0),
                                        dt(2019, 9, 1, 13, 6, 0, 0)]],
    [["period(13:01, 120s)"],          [dt(2019, 9, 1, 13, 1, 0, 0),
    ...
    [["period(2019/9/1 0:50, 180s)"],  [dt(2019, 9, 1, 13, 2, 0, 0),
                                        dt(2019, 9, 1, 13, 5, 0, 0),
                                        dt(2019, 9, 1, 13, 8, 0, 0),
                                        dt(2019, 9, 1, 13, 11, 0, 0)]],
    [["period(2019/9/1 13:00, 120s, 2019/9/1 13:04)"], [dt(2019, 9, 1, 13, 2, 0, 0),
                                                        dt(2019, 9, 1, 13, 4, 0, 0),
                                                        None]],
    [["cron(0 14 * * *)"],             [dt(2019, 9, 1, 14, 0, 0, 0),
                                        dt(2019, 9, 2, 14, 0, 0, 0),
                                        dt(2019, 9, 3, 14, 0, 0, 0),
                                        dt(2019, 9, 4, 14, 0, 0, 0)]],
    [["cron(0 14 10-13 * *)"],         [dt(2019, 9, 10, 14, 0, 0, 0),
    ...
    [["cron(0 14 10,11-12,13 * *)"],   [dt(2019, 9, 10, 14, 0, 0, 0),
                                        dt(2019, 9, 11, 14, 0, 0, 0),
                                        dt(2019, 9, 12, 14, 0, 0, 0),
                                        dt(2019, 9, 13, 14, 0, 0, 0),
                                        dt(2019, 10, 10, 14, 0, 0, 0),
